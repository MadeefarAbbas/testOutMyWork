                            ...
                            <div class="portlet light border border-grey">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-purple-soft bold uppercase"> {{$company_obj->name}} - Add Post  </span>
                                    </div>
                                    {{--<div class="actions">--}}
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade active in" id="tab_1_1">
                                                    ...
                                                    @endif
                                                        ...
                                                        <form method="post" action="{{config('constants.base_url')}}/company/{{$company_obj->id}}/posts" enctype="multipart/form-data">
                                                        @csrf
...
height: 150px; line-height: 150px;"></div>
                                                    ...
                                                    <div wt-copy="field" style="display:none; ">
                                                        <div wt-duplicate="field" class="margin-top-10">
                                                            <input  type="text" class="form-control col-md-10 margin-bottom-10" style="width:95%;" name="features[]">
                                                            <a href="javascript:;" wt-delete="field"><i class="margin-top-10 margin-bottom-10 margin-left-5 fa fa-trash fa-lg"></i></a>
                                                    ...
                                                    <div wt-copy="benefits" style="display:none; ">
                                                        <div wt-duplicate="benefits" class="margin-top-10">
                                                            <input  type="text" class="form-control col-md-10 margin-bottom-10" style="width:95%;" name="benefits[]">
                                                            <a href="javascript:;" wt-delete="benefits"><i class="margin-top-10 margin-bottom-10 margin-left-5 fa fa-trash fa-lg"></i></a>
